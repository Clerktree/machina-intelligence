...
from 4,096-sample vibration windows and a sigmoid-calibrated ExtraTrees
classifier. Training used
...
The classifier abstains below its configured confidence threshold.
